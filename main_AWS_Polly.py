...
# Leer el contenido de los archivos de contexto
context_files = ["MS120-24.txt", "MR46.txt", "MX67.txt"]
additional_context = ""
...
def agregar_json_al_contexto(json_file, context_variable):
    try:
        ...
        print(f"Contenido de {json_file} agregado exitosamente al contexto.")
        return context_variable
    except Exception as e:
        print(f"Error procesando el archivo JSON {json_file}: {e}")
        return context_variable
...
for file_name in context_files:
    ...
    if file_path.exists():
        with open(file_path, "r", encoding="utf-8") as file:
            ...
            print(f"Archivo {file_name} cargado en el contexto.")
...
ASSISTANT_CONTEXT = (
    ...
    f"{additional_context}"  # Incluir el contenido de los archivos .txt
)
